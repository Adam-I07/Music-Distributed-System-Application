import socket
import threading
from fileDistributionConnectionHandler import fileDistributionConnectionHandler
...
class fileDistributionNetworkInterface:
    def __init__(self):
        self.listeners = []
        self.connectionHandler = fileDistributionConnectionHandler()
        self.running = True
